...
public class CalendarUtils {
     ...
     * @return
     */
    public static Date addDates(Date date, int add) {
     ...
     * @return
     */
    public static String getSampleStringFormatDate(Date date) {
        SimpleDateFormat sdf = new SimpleDateFormat(DATE_PATTERN);
        return sdf.format(date);
    }

    public static String getSampleDateFormatString(Date date){
        return getDateFormatString(date,DATE_PATTERN);
    }

    public static Date getSampleDateFormatString(String date) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat(DATE_PATTERN);
    ...
    public static Date getSampleDateFromString(String dateStr){
        return getDateFromString(dateStr,DATE_PATTERN);
    }
